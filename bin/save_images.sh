...
echo "Saving django..."
docker save -o ${DIST_DIR}/django/aqi-django.tar ${DOCKER_USER}/aqi-django:${DJANGO_TAG}
echo "Saving nginx..."
docker save -o ${DIST_DIR}/nginx/aqi-nginx.tar ${DOCKER_USER}/aqi-nginx:${NGINX_TAG}
echo "Saving postgis..."
docker save -o ${DIST_DIR}/postgis/aqi-postgis.tar ${DOCKER_USER}/aqi-postgis:${POSTGIS_TAG}
